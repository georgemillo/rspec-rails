...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activesupport>, [">= 5.0.0.beta2", "< 5.1"])
  s.add_runtime_dependency(%q<actionpack>, [">= 5.0.0.beta2", "< 5.1"])
  s.add_runtime_dependency(%q<railties>, [">= 5.0.0.beta2", "< 5.1"])
